...
// A simple custom logo: abstract shield with a cobra-inspired mark and a hint of the letter 'K'.
// Accessible: aria-label provided in the SVG element.
